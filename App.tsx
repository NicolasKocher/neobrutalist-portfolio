...
const experienceData = [
  {
    ...
    logo: "/logos/inserteffect-logo.jpeg",
  },
  {
    ...
    description:
      "My practical semester at adesso SE was particularly valuable as I learned firsthand how agile work with Scrum really functions in daily practice. By taking on various roles—from Requirements Engineer to Product Owner to Scrum Master and Software Engineer—I gained a comprehensive insight into the entire lifecycle of an IT project. I not only learned about modern technologies and development processes but also experienced teamwork in a dynamic environment. This internship was my entry into real, team-oriented work and has had a lasting impact on my work style.",
    logo: "/logos/adesso-logo.png",
  },
  {
  ...
  },
  {
    ...
    description:
      "At Fraunhofer IIS, I independently developed an internal web application. I used modern web technologies such as HTML, CSS, JavaScript, and TypeScript, as well as React for a component-based architecture. A key focus was the integration of REST APIs and the clean processing of backend data. Through a focus on user-friendliness and clear interfaces, I was able to deepen my technical skills and apply them in a practical way.",
    logo: "/logos/fraunhofer-logo.jpg",
  },
];
    ...
    <div className="font-sans text-black overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 md:px-8 py-12 md:py-24 space-y-20 md:space-y-32 pt-24 md:pt-32">
        ...
        <AnimatedSection>
          ...
          >
            <h2 className="text-4xl md:text-5xl font-black tracking-tight lg:col-span-1">
              ABOUT ME
            </h2>
            <Card
              className="lg:col-span-2"
              shadowColor="shadow-[8px_8px_0px_#0ea5e9]"
            >
              <p className="text-lg md:text-xl font-normal leading-relaxed">
                I'm an aspiring software developer with a passion for modern
                technologies and agile methods. My focus is on creating
                innovative and user-friendly web and mobile applications that
                provide real-world value.
              </p>
              <br />
              <p className="text-lg md:text-xl font-normal leading-relaxed">
                With hands-on experience in frameworks like Angular, React,
                Svelte, and Flutter, I enjoy building full-stack solutions and
                collaborating in dynamic team environments to bring ideas to
                life.
              </p>
            </Card>
          </section>
          ...
          <section id="skills">
            ...
            <div className="flex flex-wrap gap-3 md:gap-4">
              {skills.map((skill) => (
                <div
                  key={skill}
                  className="bg-white text-base md:text-lg font-bold border-2 border-black py-2 px-4 shadow-[4px_4px_0px_#000] hover:shadow-none hover:translate-x-1 hover:translate-y-1 transition-all cursor-default"
                >
                  {skill}
                </div>
              ))}
